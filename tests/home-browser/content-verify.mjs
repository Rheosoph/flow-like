...
try {
	...
	await page.waitForFunction(
		() => document.querySelectorAll("[data-home-widget]").length === 7,
	);
	await page.getByRole("heading", { name: "New apps", exact: true }).waitFor();
	...
	report.passed.push(
		"Actual default layout renders seven catalog widgets at 1480px, 768px, and 390px without horizontal page overflow",
	);
