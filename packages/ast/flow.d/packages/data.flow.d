 ...
 * @impure has side effects / drives control flow
 */
declare function dfRegisterAthena({ session: Struct, region?: string, accessKeyId: string, secretAccessKey: string, s3OutputLocation: string, catalog?: string, database: string, sourceTable: string, tableName: string, workgroup?: string, odbcDriver?: string }): { sessionOut: Struct, connectionInfo: string };
