...
CREATE INDEX ASYNC "AccountCapacity_initialized_updatedAt_payerId_idx" ON "AccountCapacity"(initialized,"updatedAt","payerId");
...
CREATE INDEX ASYNC "ProjectCapacity_payerId_active_idx" ON "ProjectCapacity"("payerId", "active");
...
CREATE INDEX ASYNC "StorageUploadGrant_expiresAt_idx" ON "StorageUploadGrant"("expiresAt");
CREATE INDEX ASYNC "StorageUploadGrant_appId_idx" ON "StorageUploadGrant"("appId");
