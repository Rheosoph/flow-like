...
CREATE INDEX ASYNC "DeviceCertificateInventory_nextCheckAt_idx" ON "DeviceCertificateInventory"("nextCheckAt");
...
CREATE INDEX ASYNC "DeviceCertificateNotice_status_nextAttemptAt_idx" ON "DeviceCertificateNotice"(status, "nextAttemptAt");
CREATE INDEX ASYNC "DeviceCertificateNotice_deviceId_idx" ON "DeviceCertificateNotice"("deviceId");
