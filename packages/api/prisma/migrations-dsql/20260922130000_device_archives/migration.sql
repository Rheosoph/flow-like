...
CREATE INDEX ASYNC "DeviceArchive_ownerId_expiresAt_idx" ON "DeviceArchive"("ownerId", "expiresAt");
CREATE INDEX ASYNC "DeviceArchive_expiresAt_idx" ON "DeviceArchive"("expiresAt");
