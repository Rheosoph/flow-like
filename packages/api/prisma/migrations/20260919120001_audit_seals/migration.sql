...
CREATE INDEX "AuditRecord_chainId_timestamp_id_idx" ON "AuditRecord"("chainId","timestamp",id);
CREATE INDEX "AuditRecord_sealId_chainId_timestamp_id_idx" ON "AuditRecord"("sealId","chainId","timestamp",id);
CREATE UNIQUE INDEX "AuditSeal_chainId_seq_key" ON "AuditSeal"("chainId",seq);
CREATE INDEX "AuditSeal_epochSeq_epochIndex_idx" ON "AuditSeal"("epochSeq","epochIndex");
CREATE INDEX "AuditSeal_class_lastAt_idx" ON "AuditSeal"(class,"lastAt");
CREATE INDEX "AuditSeal_ipPending_lastAt_idx" ON "AuditSeal"("ipPending","lastAt");
CREATE INDEX "AuditSeal_detailsPending_lastAt_idx" ON "AuditSeal"("detailsPending","lastAt");
CREATE INDEX "AuditEpoch_createdAt_idx" ON "AuditEpoch"("createdAt");
CREATE INDEX "AuditWatermark_prunedAt_idx" ON "AuditWatermark"("prunedAt");
CREATE INDEX "AuditWatermark_pendingDelete_idx" ON "AuditWatermark"("pendingDelete");
