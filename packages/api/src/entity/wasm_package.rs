...
pub struct Model {
    ...
    pub visibility: WasmPackageVisibility,
}
...
pub enum Relation {
    ...
    WasmPackageAuthor,
    #[sea_orm(has_many = "super::wasm_package_invitation::Entity")]
...
impl Related<super::wasm_package_invitation::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::WasmPackageInvitation.def()
    }
}
