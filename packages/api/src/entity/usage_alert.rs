...
pub struct Model {
    ...
    #[sea_orm(column_name = "thresholdPercent", nullable)]
    pub threshold_percent: Option<i32>,
    #[sea_orm(column_name = "currentCostMicroDollars", nullable)]
    pub current_cost_micro_dollars: Option<i64>,
    #[sea_orm(column_name = "currentTokens", nullable)]
    pub current_tokens: Option<i64>,
    #[sea_orm(column_name = "acknowledgedAt", nullable)]
