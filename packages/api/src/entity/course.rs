...
use super::sea_orm_active_enums::CourseCategory;
use super::sea_orm_active_enums::CourseDifficulty;
...
impl Related<super::learning_path::Entity> for Entity {
    fn to() -> RelationDef {
        super::learning_path_course::Relation::LearningPath.def()
    }
    fn via() -> Option<RelationDef> {
        Some(super::learning_path_course::Relation::Course.def().rev())
    }
}
