					...
					<div className="flex flex-wrap items-start justify-between gap-3">
						<div>
							...
							<p className="text-muted-foreground">
								Grouped crashes and errors reported by installs — anonymous, no
								user identity.
							</p>
						</div>
						<div className="flex flex-wrap items-center gap-2">
					...
					<Card>
						<CardHeader className="pb-3">
							<div className="flex flex-wrap items-center gap-2">
								<div className="relative min-w-[14rem] flex-1">
									...
									<Input
										...
										placeholder="Search title, kind or culprit"
										className="pl-8"
									/>
								</div>
								<Select
							...
							<CardDescription className="flex flex-wrap items-center gap-3">
								<span>{total.toLocaleString()} matching issues</span>
								<span className="inline-flex items-center gap-1">
									<Zap className="h-3 w-3" />
									{totalEvents.toLocaleString()} events on this page
								</span>
								<span className="inline-flex items-center gap-1">
									<MonitorSmartphone className="h-3 w-3" />
									{totalInstalls.toLocaleString()} installs affected
								</span>
							</CardDescription>
						</CardHeader>
