...
> = {
	...
	feedback: {
		...
		description: str(""),
		positiveLabel: str("Yes"),
		negativeLabel: str("No"),
		positiveRating: num(5),
		negativeRating: num(1),
		showComment: bool(false),
		commentMode: str("modal"),
		commentLabel: str("Comment"),
		commentPlaceholder: str("Optional comment"),
		commentTitle: str("Add feedback"),
		commentDescription: str("Share a little more context before submitting."),
		commentSubmitLabel: str("Submit feedback"),
		commentCancelLabel: str("Cancel"),
		feedbackId: str(""),
		includeState: bool(true),
		pageContextMode: str("path"),
		pageContextQueryParamAllowlist: str(""),
		pageContextQueryParamDenylist: str(""),
		includePageHash: bool(false),
		successMessage: str("Thanks for the feedback."),
		disabled: bool(false),
	},
	appLink: {
		target: str("config"),
		...
		events: {
			literalJson: JSON.stringify([
				...
				},
				{
					...
					end: "2026-07-09T15:30:00",
					color: "#8b5cf6",
					description: "Walk through the latest mockups.",
					link: "https://flow-like.com",
				},
				{
					id: "e3",
					title: "1:1 sync",
					start: "2026-07-09T14:30:00",
	...
	gantt: {
		...
		showToday: bool(true),
		showViewSwitcher: bool(true),
		showTaskList: bool(true),
		shadeWeekends: bool(true),
		height: str("560px"),
		responsive: bool(true),
	},
	lottie: {
	...
	diffView: {
		...
		modified: str("function greet(name) {\n  return `Hello, ${name}!`;\n}"),
		mode: str("split"),
		kind: str("auto"),
		language: str("plaintext"),
		markdownMode: str("source"),
		showLineNumbers: bool(true),
		wordWrap: bool(false),
		wordLevel: bool(true),
		collapseUnchanged: bool(false),
		contextLines: num(3),
		showStats: bool(true),
		originalLabel: str("Original"),
		modifiedLabel: str("Modified"),
		ignoreWhitespace: bool(false),
		ignoreCase: bool(false),
		trimTrailingWhitespace: bool(false),
