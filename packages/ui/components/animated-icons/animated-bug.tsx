			...
			>
				...
				>
					...
					<motion.path
						...
						variants={{
							initial: { rotate: 0 },
							hover: { rotate: 15, scale: 1.2, transition: { type: "spring" } },
						}}
					/>
					...
					<motion.path
						...
						variants={{
							initial: { scaleX: 1 },
							hover: { scaleX: 1.4, transition: { type: "spring" } },
						}}
					/>
					<motion.path
						d="M16 14h4"
					...
					{/* Bottom Legs */}
					<motion.path
						d="M9.5 19c-1.7 1.5-3 2-5 2"
						style={{ transformOrigin: "9.5px 19px" }}
						variants={{
							initial: { rotate: 0 },
							hover: {
								rotate: 20,
					...
					/>
					<motion.path
						d="M14.5 19c1.7 1.5 3 2 5 2"
						style={{ transformOrigin: "14.5px 19px" }}
						variants={{
							initial: { rotate: 0 },
							hover: {
								rotate: -20,
