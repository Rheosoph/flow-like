...
export function AnimatedPackageIcon({ className }: { className?: string }) {
    ...
    const outerBoxPath = "M16.76 3a2 2 0 0 1 1.8 1.1l2.23 4.479a2 2 0 0 1 .21.891V19a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V9.472a2 2 0 0 1 .211-.894L5.45 4.1A2 2 0 0 1 7.24 3z";
    ...
    return (
        ...
        >
            ...
            <motion.ellipse
                ...
                variants={{
                    initial: { scaleX: 0.8, opacity: 0, y: 0, transition: returnTransition },
            ...
            */}
            ...
            >
                ...
                <motion.g
                    variants={{
                        initial: { y: 2, scale: 0.3, opacity: 0, transition: { duration: 0.2 } },
                        hover: { y: 0, scale: 1, opacity: 1, transition: { delay: 0.1, ...springFlower } }
                    }}
                ...
                >
                    ...
                    <motion.path
                        ...
                        variants={{
                            ...
                            hover: { pathLength: 1, transition: { duration: 0.5, delay: 0.1 } }
                        }}
                    />

                    {/* Side Stems spread wide */}
                    <motion.path d="M 12 9 Q 7 6, 4 5" className="stroke-emerald-600 dark:stroke-emerald-500" strokeWidth="1.5" fill="none" variants={{ initial: { pathLength: 0 }, hover: { pathLength: 1, transition: { duration: 0.4, delay: 0.15 } } }} />
                    <motion.path d="M 12 9 Q 17 6, 20 5" className="stroke-emerald-600 dark:stroke-emerald-500" strokeWidth="1.5" fill="none" variants={{ initial: { pathLength: 0 }, hover: { pathLength: 1, transition: { duration: 0.4, delay: 0.15 } } }} />

                    {/* CENTRAL GIANT FLOWER (Massive petals, bursts past y=0) */}
                    <motion.g variants={{ initial: { scale: 0 }, hover: { scale: 1, transition: { type: "spring", delay: 0.3 } } }} style={{ transformOrigin: "12px 2.5px" }}>
                        {/* 8 thick petals for a full look */}
                        {[0, 45, 90, 135, 180, 225, 270, 315].map(angle => (
                            <ellipse key={angle} cx="12" cy="2.5" rx="2.5" ry="6.5" className="fill-pink-400 stroke-none dark:fill-pink-500" style={{ transformOrigin: "12px 2.5px", transform: `rotate(${angle}deg)` }} />
                        ))}
                        <circle cx="12" cy="2.5" r="3" className="fill-yellow-300 stroke-none dark:fill-yellow-400" />
                    </motion.g>

                    {/* LEFT SIDE FLOWER (Pushed far left) */}
                    <motion.g variants={{ initial: { scale: 0 }, hover: { scale: 1, transition: { type: "spring", delay: 0.35 } } }} style={{ transformOrigin: "4px 5px" }}>
                        {[0, 60, 120, 180, 240, 300].map(angle => (
                            <ellipse key={angle} cx="4" cy="5" rx="1.5" ry="4" className="fill-purple-400 stroke-none dark:fill-purple-500" style={{ transformOrigin: "4px 5px", transform: `rotate(${angle}deg)` }} />
                        ))}
                        <circle cx="4" cy="5" r="2" className="fill-yellow-300 stroke-none dark:fill-yellow-400" />
                    </motion.g>

                    {/* RIGHT SIDE FLOWER (Pushed far right) */}
                    <motion.g variants={{ initial: { scale: 0 }, hover: { scale: 1, transition: { type: "spring", delay: 0.4 } } }} style={{ transformOrigin: "20px 5px" }}>
                        {[30, 90, 150, 210, 270, 330].map(angle => (
                            <ellipse key={angle} cx="20" cy="5" rx="1.5" ry="4" className="fill-orange-400 stroke-none dark:fill-orange-500" style={{ transformOrigin: "20px 5px", transform: `rotate(${angle}deg)` }} />
                        ))}
                        <circle cx="20" cy="5" r="2" className="fill-yellow-300 stroke-none dark:fill-yellow-400" />
                    </motion.g>
                </motion.g>
                ...
                <motion.g
                    ...
                    variants={{ initial: { rotate: 0 }, hover: { rotate: -115, transition: springFlaps } }}
                >
                ...
                >
                    <motion.path
                        ...
                        variants={{
                            initial: { pathLength: 0 },
                            hover: { pathLength: 1, transition: { duration: 0.6, delay: 0.25, ease: "easeOut" } }
                        }}
                    />
                    <motion.path
                        d="M 4 15 Q 1 14, 2 12 Q 5 13, 4 15 Z"
                        className="fill-emerald-500 stroke-none dark:fill-emerald-400"
                        variants={{ initial: { scale: 0 }, hover: { scale: 1, transition: { delay: 0.5 } } }}
                    ...
                    <motion.path
                        ...
                        variants={{
                            initial: { pathLength: 0 },
                            hover: { pathLength: 1, transition: { duration: 0.6, delay: 0.3, ease: "easeOut" } }
                        }}
                    />
                    <motion.path
                        d="M 20 15 Q 23 14, 22 12 Q 19 13, 20 15 Z"
                        className="fill-emerald-600 stroke-none dark:fill-emerald-500"
                        variants={{ initial: { scale: 0 }, hover: { scale: 1, transition: { delay: 0.6 } } }}
