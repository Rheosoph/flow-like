...
export function AutoPlayNewProjectIcon({ className }: { className?: string }) {
	...
	return (
		<div
			className={cn(
				"relative flex items-center justify-center w-12 h-12 text-slate-400 dark:text-slate-500",
				className,
			)}
		>
			<motion.svg
				...
				viewBox="0 0 24 24"
				fill="none"
				stroke="currentColor" // <-- RESTORED HERE AS WELL
				strokeWidth="2"
				strokeLinecap="round"
				strokeLinejoin="round"
				animate={isAssembled ? "assembled" : "initial"}
				initial="initial"
					...
					<motion.g
						...
						variants={{
							...
							assembled: {
								...
								scale: 1,
								opacity: 1,
								transition: { ...dockTransition, delay: 0.05 },
							},
						}}
					>
					...
					<motion.g
						...
						variants={{
							...
							assembled: {
								...
								scale: 1,
								opacity: 1,
								transition: { ...dockTransition, delay: 0.1 },
							},
						}}
					>
					...
					<motion.g
						...
						variants={{
							...
							assembled: {
								...
								scale: 1,
								opacity: 1,
								transition: { ...dockTransition, delay: 0.15 },
							},
						}}
					>
					...
					<motion.g
						...
						variants={{
							...
							assembled: {
								...
								scale: 1,
								opacity: 1,
								transition: { ...dockTransition, delay: 0.2 },
							},
						}}
					>
