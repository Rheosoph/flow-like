	...
	return (
		<div className="relative flex h-full min-h-0 flex-col">
				...
				<Popover>
					...
					<PopoverContent align="end" className="w-64 space-y-3">
						<div className="grid gap-1.5">
							...
							>
								<SelectTrigger className="h-8" aria-label="Source column">
						...
						<div className="grid gap-1.5">
							...
							>
								<SelectTrigger className="h-8" aria-label="Target column">
									<SelectValue placeholder="Select" />
								</SelectTrigger>
								<SelectContent>
									{columns.map((column) => (
			...
			{!ready ? (
				...
				<div
					role="img"
					aria-label={`Relationship graph with ${data.nodes.length} nodes and ${data.links.length} links`}
