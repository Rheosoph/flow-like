...
const headingVariants = cva("relative mb-1", {
	variants: {
		variant: {
				...
				h3: "mt-[0.6em] pb-px font-heading text-xl font-semibold tracking-tight",
				h4: "mt-[0.5em] font-heading text-lg font-semibold tracking-tight",
				h5: "mt-[0.5em] text-lg font-semibold tracking-tight",
				h6: "mt-[0.5em] text-base font-semibold tracking-tight",
		},
	},
});
