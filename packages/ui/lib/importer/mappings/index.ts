...
export const MAPPING_DEFS: Record<string, NodeMappingDef> = {
	...
	respond_to_webhook: { n8n: respond_to_webhook_n8n, flow: respond_to_webhook_flow },
	...
	model_azure_openai: { n8n: model_azure_openai_n8n, flow: model_azure_openai_flow },
	...
	model_huggingface: { n8n: model_huggingface_n8n, flow: model_huggingface_flow },
