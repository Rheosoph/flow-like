...
#[crate::register_node]
#[derive(Default)]
pub struct BuildGeminiNode {}

impl BuildGeminiNode {
    pub fn new() -> Self {
        BuildGeminiNode {}
    }
}
...
#[async_trait]
impl NodeLogic for BuildGeminiNode {
    fn get_node(&self) -> Node {
        let mut node = Node::new(
            "ai_generative_build_gemini",
            "Gemini Model",
        ...
        .set_default_value(Some(json!("https://generativelanguage.googleapis.com")));

        node.add_input_pin("api_key", "API Key", "Gemini API key", VariableType::String)
    ...
    async fn run(&self, context: &mut ExecutionContext) -> flow_like_types::Result<()> {
        ...
        let params_obj = VLMParameters {
            ...
            provider: flow_like_model_provider::provider::ModelProvider {
                provider_name: "custom:gemini".into(),
