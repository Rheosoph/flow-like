...
fn create_simple_pdf() -> Vec<u8> {
    ...
    let page_contents = [
        ...
        concat!(
            ...
            "BT /F1 10 Tf 0.416 0.416 0.416 rg 50 400 Td (flow-like.com  |  github.com/TM9657/flow-like) Tj ET\n",
        ...
        concat!(
            ...
            "BT /F1 11 Tf 0.102 0.102 0.102 rg 50 560 Td (Review the source at github.com/TM9657/flow-like.) Tj ET\n",
