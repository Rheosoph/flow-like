...
#[crate::register_node]
#[derive(Default)]
pub struct InsertSetRefNode {}

impl InsertSetRefNode {
    pub fn new() -> Self {
        InsertSetRefNode {}
    }
}
...
#[async_trait]
impl NodeLogic for InsertSetRefNode {
    ...
    async fn run(&self, context: &mut ExecutionContext) -> flow_like_types::Result<()> {
        ...
        context.set_pin_value("was_new", json!(was_new)).await?;
