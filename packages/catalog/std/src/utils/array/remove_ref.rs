...
#[crate::register_node]
#[derive(Default)]
pub struct RemoveIndexArrayRefNode {}

impl RemoveIndexArrayRefNode {
    pub fn new() -> Self {
        RemoveIndexArrayRefNode {}
    }
}

#[async_trait]
impl NodeLogic for RemoveIndexArrayRefNode {
    fn get_node(&self) -> Node {
        ...
        node.add_output_pin("value", "Value", "The removed value", VariableType::Generic);
    ...
    async fn run(&self, context: &mut ExecutionContext) -> flow_like_types::Result<()> {
        ...
        context.set_pin_value("value", json!(removed)).await?;
