---
title: Licensing
description: Flow-Like licensing options and terms
sidebar:
  order: 10
---

Flow-Like is available under different licensing terms depending on your use case.
...
- Offering Flow-Like as a hosted service
- Priority support and SLA
- Custom development services

→ See [White-Labeling](/enterprise/whitelabeling/) for details.
