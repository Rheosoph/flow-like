...
Currently, Flow-Like is only available as a desktop application. However, [we are working on an **online version**](https://github.com/Rheosoph/flow-like/discussions/101) that will be accessible via web browsers.
