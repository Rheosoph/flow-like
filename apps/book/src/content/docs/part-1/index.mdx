...
description: Begin FlowBook with the incident that inspired Flow-Like, the principles behind visible software, the platform model, and a first Flow.
seo:
...
data, and execution. The final chapter turns the argument into a small program you can inspect in two
authoring views.
...
- distinguish an App, Flow, Board, Event, and authoring view; and
