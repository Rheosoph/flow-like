export const nlSecurity = {
	...
	"security.meta.description":
		"Gebouwd op Rust met geheugensveiligheid, RBAC, volledige audittrails, datasoevereiniteit en open-source transparantie. Enterprise-beveiliging zonder de enterprise-complexiteit.",
