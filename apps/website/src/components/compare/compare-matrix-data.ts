export function createCompareMatrixData(t: (key: string) => string) {
	...
	const source = (label: string, url: string): SupportNoteSource => ({
		label,
		url,
	});
	...
	const competitorResearch: Record<string, CompetitorResearch> = {
		Zapier: {
			...
			sources: [
				source(
					"Zapier Agents knowledge files",
					"https://help.zapier.com/hc/en-us/articles/24569690575117-Add-your-own-data-to-an-agent",
				),
				...
				visual_workflow: note(
					...
					[
						source(
							...
							"https://help.zapier.com/hc/en-us/articles/16722578092429-Use-the-editor-to-build-and-view-your-Zaps",
						),
						source("Zapier product overview", "https://zapier.com/"),
					],
		...
		n8n: {
			...
			cells: {
				...openWorkflowToolCells(
					"n8n",
					"workflow automation, integrations, and AI workflow orchestration",
					[
						source("n8n docs", "https://docs.n8n.io/"),
						source("n8n advanced AI docs", "https://docs.n8n.io/advanced-ai/"),
						source(
						...
						source(
							"n8n binary data environment variables",
		...
		"Node-RED": {
			...
			cells: {
				...openWorkflowToolCells(
					"Node-RED",
					"event-driven integrations, IoT-style automation, and Node.js flows",
					[
						source("Node-RED docs", "https://nodered.org/docs/"),
						source(
							"Node-RED flow editor",
		...
		Retool: {
			...
			sources: [
				...
				source(
					...
					"https://retool.com/launch-enterprise-apps/external",
				),
				source(
			...
			cells: {
				...lowCodeAppCells(
					"Retool",
					"internal app screens, database/API queries, mobile apps, workflows, and agents",
					[
						source("Retool docs", "https://docs.retool.com/"),
						source("Retool Mobile", "https://retool.com/products/mobile/"),
						source(
							"Retool Workflows docs",
				...
				file_size: {
					...
					sources: [
						source(
							"Retool Storage",
							"https://retool.com/integrations/retool-storage",
						),
						source(
							"Retool file upload limit discussion",
							"https://community.retool.com/t/max-filesize-upload-limit/19821",
						),
					],
					checkedAt: "2026-05-30",
				},
				governance: {
					...
					sources: [
						source(
							"Retool administration docs",
							"https://docs.retool.com/org-users",
						),
						source(
							"Retool permissions docs",
							"https://docs.retool.com/permissions",
						),
						source(
							"Retool trust guide",
							"https://try.retool.com/resource/trust-guide",
						),
					],
					checkedAt: "2026-05-30",
				},
				...
				local_first: note(
					...
					[
						...
						source(
							"Retool self-hosting",
							"https://retool.com/govern-enterprise-apps/self-hosted",
						),
						source(
							"Retool Workflows docs",
							"https://docs.retool.com/workflows",
		...
		"Power Apps": {
			...
			sources: [
				...
				source(
					"Power Apps Agent Builder GA",
					"https://learn.microsoft.com/en-us/power-platform/release-plan/2025wave1/power-apps/ga-agent-builder-power-apps",
				),
				source(
			...
			cells: {
				...lowCodeAppCells(
					"Power Apps",
					"canvas/model-driven app building, Dataverse, and Microsoft Power Platform workflows",
					[
						source(
							"Model-driven app overview",
							"https://learn.microsoft.com/en-us/power-apps/maker/model-driven-apps/model-driven-app-overview",
				...
				file_size: {
					...
					sources: [
						source(
							"Dataverse file column definitions",
							"https://learn.microsoft.com/en-us/power-apps/developer/data-platform/file-attributes",
						),
						source(
							"Use Dataverse file columns",
				...
				ai_agents: {
					...
					sources: [
						...
						source(
							"Build an AI agent from a canvas app",
				...
				mobile: {
					...
					sources: [
						source(
							"Power Apps mobile offline overview",
		...
		Superblocks: {
			...
			sources: [
				...
				source(
					"Superblocks hosting overview",
					"https://docs.superblocks.com/hosting/overview",
				),
				source(
					"Superblocks size and time limits",
					"https://docs.superblocks.com/enterprise/hybrid-architecture/manage/size_and_time_limits",
				),
				source(
					"Building with Clark AI",
					"https://docs.superblocks.com/building-with-clark",
				),
			],
			cells: {
				...lowCodeAppCells(
					"Superblocks",
					"internal apps, governed integrations, workflows, and embedded app delivery",
					[
						source("Superblocks docs", "https://docs.superblocks.com/"),
						source(
							"Superblocks hosting overview",
				...
				replayable: {
					...
					sources: [
						source(
							"Superblocks checkpoints and rollbacks",
							"https://docs.superblocks.com/building-with-clark/checkpoints",
						),
						source(
							"Building with Clark AI",
							"https://docs.superblocks.com/building-with-clark",
				...
				ai_agents: {
					...
					sources: [
						...
						source(
							...
							"https://docs.superblocks.com/building-with-clark/plan-and-build-modes",
						),
					],
					checkedAt: "2026-05-30",
				},
				...
				customer_facing: {
					...
					sources: [
						...
						source(
							"Superblocks embedded authentication",
							"https://docs.superblocks.com/hosting/embedded-apps/authentication",
						),
					],
					checkedAt: "2026-05-30",
				},
				self_hosted: {
					...
					sources: [
						source(
							"Superblocks enterprise deployment",
							"https://docs.superblocks.com/enterprise/deployment-overview",
						),
						source(
							"Superblocks hybrid overview",
							"https://docs.superblocks.com/enterprise/hybrid-architecture/overview",
						),
						source(
							"Superblocks Cloud-Prem AWS",
							"https://docs.superblocks.com/enterprise/cloud-prem/aws",
						),
					],
					checkedAt: "2026-05-30",
				},
				governance: {
					...
					sources: [
						source(
							...
							"https://docs.superblocks.com/getting-started/what-is-superblocks",
						),
						source(
							"Superblocks RBAC",
							"https://docs.superblocks.com/admin/org-administration/rbac",
						),
						source(
							"Superblocks audit logs",
							"https://docs.superblocks.com/admin/audit-logs",
						),
					],
					checkedAt: "2026-05-30",
				},
				mobile: note(
					...
					[
						source(
							"Superblocks embedded apps",
							"https://docs.superblocks.com/hosting/embedded-apps/overview",
						),
						source(
							"Superblocks hosting overview",
							"https://docs.superblocks.com/hosting/overview",
		...
		Appsmith: {
			...
			cells: {
				...lowCodeAppCells(
					"Appsmith",
					"internal app pages, widgets, JavaScript logic, and data-source integrations",
					[
						source("Appsmith docs", "https://docs.appsmith.com/"),
						source("Appsmith Agents docs", "https://docs.appsmithai.com/"),
						source("Appsmith pricing", "https://www.appsmith.com/pricing"),
				...
				replayable: {
					...
					sources: [
						source(
							"Appsmith Workflow Run History",
							"https://docs.appsmith.com/workflows/reference/run-history",
						),
					],
					checkedAt: "2026-05-30",
				},
				file_size: {
					...
					sources: [
						source("Appsmith docs", "https://docs.appsmith.com/"),
						source(
							"Appsmith Filepicker blog",
							"https://www.appsmith.com/blog/upload-and-manage-files-on-cloudinary-with-the-filepicker-widget",
						),
						source(
							"Appsmith 5 MB filepicker discussion",
							"https://old-community.appsmith.com/t/filepicker-upload-file-bigger-than-5mb-catch-uncaughtpromiserejection/1700",
						),
					],
					checkedAt: "2026-05-30",
				},
				ai_agents: {
					...
					sources: [
						source("Appsmith Agents docs", "https://docs.appsmithai.com/"),
						source(
							"Appsmith Agents launch",
							"https://www.appsmith.com/blog/introducing-appsmith-agents",
						),
					],
					checkedAt: "2026-05-30",
				},
				...
				governance: {
					...
					sources: [
						...
						source(
							"Appsmith audit logs",
							"https://docs.appsmith.com/advanced-concepts/audit-logs",
						),
					],
					checkedAt: "2026-05-30",
				},
				...
				mobile: note(
					...
					[
						source(
							"Appsmith overview",
							"https://docs.appsmith.com/build-apps/overview",
						),
						source("Appsmith docs", "https://docs.appsmith.com/"),
					],
				),
				...
				concurrent_state: note(
					...
					[
						...
						source(
							...
							"https://docs.appsmith.com/reference/appsmith-framework/context-object",
						),
					],
				),
			},
		...
		Tableau: {
			...
			sources: [
				source(
					"Tableau Prep Flow Workspace",
					"https://help.tableau.com/current/server/en-us/prep_conductor_workspace.htm",
				),
				source(
					"Tableau Prep on the Web",
					"https://help.tableau.com/current/prep/en-gb/prep_web_auth.htm",
				),
				source(
					"Tableau Agent",
				...
				source(
					"Tableau Embedding API authentication",
					"https://help.tableau.com/current/api/embedding_api/en-us/docs/embedding_api_auth.html",
				),
				source(
					"Tableau governance",
					"https://help.tableau.com/current/blueprint/en-us/bp_governance_in_tableau.htm",
				),
			...
			cells: {
				...biPlatformCells(
					"Tableau",
					"dashboards, Tableau Prep flows, extracts, and governed analytics",
					[
						source(
							"Tableau Prep Flow Workspace",
							"https://help.tableau.com/current/server/en-us/prep_conductor_workspace.htm",
				...
				visual_workflow: note(
					...
					[
						source(
							...
							"https://help.tableau.com/current/online/en-us/prep_conductor_online_intro.htm",
						),
						source(
							"Tableau Prep Flow Workspace",
							"https://help.tableau.com/current/server/en-us/prep_conductor_workspace.htm",
				...
				customer_facing: {
					...
					sources: [
						...
						source(
							"Configure Tableau connected apps",
				...
				mobile: {
					...
					sources: [
						source(
							...
							"https://help.tableau.com/current/mobile/mobile-user/en-us/tableau_mobile_explore.htm",
						),
					],
					checkedAt: "2026-05-30",
				},
				...
				governance: {
					...
					sources: [
						...
						source(
							"Audit permissions with Activity Log",
							"https://help.tableau.com/current/server-linux/en-us/activity_log_audit_permissions.htm",
						),
					],
					checkedAt: "2026-05-30",
				},
		...
		"Power BI": {
			...
			sources: [
				source(
					...
					"https://learn.microsoft.com/en-za/power-bi/enterprise/service-premium-large-models",
				),
				source(
					"Power BI Report Server",
					"https://learn.microsoft.com/en-us/power-bi/report-server/?view=powerbi-ps",
				),
				source(
					"Copilot in Power BI",
				...
				source(
					"Power BI mobile offline",
					"https://learn.microsoft.com/en-us/power-bi/consumer/mobile/mobile-apps-offline-data",
				),
			],
			cells: {
				...biPlatformCells(
					"Power BI",
					"semantic models, reports, dashboards, refresh, and Fabric/Power BI capacity",
					[
						source(
							"Power BI large semantic models",
							"https://learn.microsoft.com/en-za/power-bi/enterprise/service-premium-large-models",
				...
				ai_agents: {
					...
					sources: [
						...
						source(
							"Power BI Copilot tutorial",
							"https://learn.microsoft.com/power-bi/create-reports/tutorial-copilot-power-bi-introduction",
						),
					],
					checkedAt: "2026-05-30",
				},
				...
				full_apps: note(
					...
					[
						...
						source(
							"Embed Power BI in a secure portal",
				...
				self_hosted: {
					...
					sources: [
						...
						source(
							"Power BI on-premises reporting scenario",
							"https://learn.microsoft.com/en-us/power-bi/guidance/powerbi-implementation-planning-usage-scenario-on-premises-reporting",
						),
					],
					checkedAt: "2026-05-30",
				},
		...
		Looker: {
			...
			sources: [
				...
				source(
					...
					"https://docs.cloud.google.com/looker/docs/sql-interface",
				),
				source(
					"Looker signed embedding",
					"https://docs.cloud.google.com/looker/docs/signed-embedding",
				),
				source(
					"Looker audit logging",
					"https://docs.cloud.google.com/looker/docs/looker-core-audit-logging",
				),
				source(
					"Looker mobile app",
					"https://docs.cloud.google.com/looker/docs/looker-core-mobile-app",
				),
				source(
					"Customer-hosted Looker",
					"https://docs.cloud.google.com/looker/docs/customer-hosted-instances",
				),
			],
			cells: {
				...biPlatformCells(
					"Looker",
					"LookML semantic models, dashboards, governed metrics, and embedded analytics",
					[
						source(
							"LookML introduction",
							"https://docs.cloud.google.com/looker/docs/what-is-lookml",
				...
				ai_agents: {
					...
					sources: [
						source(
							...
							"https://docs.cloud.google.com/looker/docs/gemini-in-looker-overview",
						),
						source(
							"Looker Conversational Analytics",
							"https://docs.cloud.google.com/looker/docs/conversational-analytics",
						),
					],
					checkedAt: "2026-05-30",
				},
				ui_builder: note(
					...
					[
						source(
							"Looker embed overview",
							"https://docs.cloud.google.com/looker/docs/embed-overview",
						),
						source(
							"Looker signed embedding",
							"https://docs.cloud.google.com/looker/docs/signed-embedding",
				...
				offline: {
					...
					sources: [
						...
						source(
							"Enable Looker mobile app",
							"https://docs.cloud.google.com/looker/docs/mobile-app-enablement",
						),
					],
					checkedAt: "2026-05-30",
				},
				...
				governance: {
					...
					sources: [
						source(
							"Prepare a Looker instance for users",
							"https://docs.cloud.google.com/looker/docs/looker-core-instance-setup",
						),
						source(
							"Looker audit logging",
							"https://docs.cloud.google.com/looker/docs/looker-core-audit-logging",
		...
		Airflow: {
			...
			cells: {
				...orchestrationCells(
					"Airflow",
					"DAGs, tasks, schedules, executors, and data pipeline orchestration",
					[
						source(
							"Airflow DAGs",
		...
		Temporal: {
			...
			sources: [
				...
				source(
					"Temporal Cloud roles and permissions",
					"https://docs.temporal.io/cloud/manage-access/roles-and-permissions",
				),
				source(
				...
				source(
					"Temporal production deployments",
			...
			cells: {
				...orchestrationCells(
					"Temporal",
					"durable workflows, activities, workers, and event-history-backed service orchestration",
					[
						source("Temporal docs", "https://docs.temporal.io/"),
				...
				replayable: {
					...
					sources: [
						...
						source(
							"Temporal deterministic constraints",
				...
				ui_builder: {
					...
					sources: [source("Temporal docs", "https://docs.temporal.io/")],
					checkedAt: "2026-05-30",
				},
				data_science: {
					summary:
		...
		"Ontology data platform": {
			...
			sources: [
				...
				source(
					"Palantir application building",
					"https://www.palantir.com/docs/foundry/app-building/overview",
				),
			],
			cells: {
				...enterpriseDataPlatformCells(
					"Ontology data platforms",
					"ontology-backed operational data, application building, workflow management, and AIP agents",
					[
						source(
							"Palantir Foundry overview",
							"https://www.palantir.com/docs/foundry/platform-overview",
		...
		"ERP process platform": {
			...
			sources: [
				source(
					...
					"https://help.sap.com/docs/build-process-automation/sap-build-process-automation/about-sap-build-process-automation",
				),
				source("SAP Build Apps", "https://help.sap.com/docs/BUILD_APPS"),
				source(
					"SAP Build Process Automation limits",
					"https://help.sap.com/docs/build-process-automation/sap-build-process-automation/limits",
				),
				source(
					"SAP Joule in SAP Build",
					"https://help.sap.com/docs/build-process-automation/sap-build-process-automation/joule-in-sap-build",
				),
			],
			cells: {
				...enterpriseDataPlatformCells(
					"ERP process platforms",
					"ERP-adjacent low-code apps, process automation, forms, workflow visibility, and desktop automation",
					[
						source(
							"SAP Build Process Automation",
							"https://help.sap.com/docs/build-process-automation/sap-build-process-automation/about-sap-build-process-automation",
						...
						source(
							"SAP Build desktop agent",
							"https://help.sap.com/docs/SAP_BUILD_PROCESS_AUTOMATION_DESKTOP_AGENT/eae9c11a17a14cfc93e08b22e8574305/16a8e1e7d4ab47b6a961fb8705c27bcb.html",
						),
						source(
							"SAP Joule in SAP Build",
							"https://help.sap.com/docs/build-process-automation/sap-build-process-automation/joule-in-sap-build",
				...
				replayable: note(
					...
					[
						...
						source(
							"SAP Build Process Automation quotas",
							"https://help.sap.com/docs/build-process-automation/sap-build-process-automation/quotas",
						),
					],
				),
				high_volume: note(
				...
				compiled: note(
					...
					[
						source(
							"What is SAP Build?",
							"https://help.sap.com/docs/build/sap-build-core/create-abap-cloud-project?locale=en-US",
						),
						source(
							"SAP Build Process Automation",
							"https://help.sap.com/docs/build-process-automation/sap-build-process-automation/about-sap-build-process-automation",
				...
				full_apps: note(
					...
					[
						...
						source(
							"SAP Build",
							"https://www.sap.com/products/technology-platform/build.html",
						),
					],
				),
				customer_facing: note(
				...
				desktop: note(
					...
					[
						source(
							"SAP Build desktop agent",
							"https://help.sap.com/docs/build-process-automation/sap-build-process-automation/about-desktop-agent-2",
						),
					],
				),
				mobile: note(
		...
		ServiceNow: {
			...
			sources: [
				source(
					...
					"https://www.servicenow.com/docs/r/washingtondc/build-workflows/build-workflows.html",
				),
				source(
				...
				source(
					...
					"https://www.servicenow.com/docs/r/mobile/mobile-config-navigation.html",
				),
				source(
					"ServiceNow manage attachments",
					"https://www.servicenow.com/docs/r/platform-user-interface/t_ManagingAttachments.html",
				),
			],
			cells: {
				...enterpriseWorkflowPlatformCells(
					"ServiceNow",
					"Flow Designer, IntegrationHub, App Engine, workspaces, and Now Platform service workflows",
					[
						source(
							"ServiceNow Flow Designer",
							"https://www.servicenow.com/docs/r/washingtondc/build-workflows/build-workflows.html",
				...
				file_size: {
					...
					sources: [
						...
						source(
							"ServiceNow attachment administration",
							"https://www.servicenow.com/docs/r/platform-administration/r_AdministeringAttachments.html",
						),
					],
					checkedAt: "2026-05-30",
				},
				...
				visual_workflow: note(
					...
					[
						...
						source(
							...
							"https://www.servicenow.com/au/products/app-engine-studio.html",
						),
						source(
							"ServiceNow application development",
							"https://www.servicenow.com/uk/products/application-development.html",
						),
					],
				),
				replayable: note(
				...
				self_hosted: note(
					...
					[
						source(
							"ServiceNow self-hosted software guide",
							"https://www.servicenow.com/content/dam/servicenow-assets/public/en-us/doc-type/legal/self-hosted-software-guide-jan2024.pdf",
						),
						source(
							"ServiceNow MID Server connectivity",
							"https://www.servicenow.com/docs/en-US/bundle/zurich-servicenow-platform/page/product/mid-server/concept/c_MIDServerConnectionPrerequisites.html",
						),
					],
				),
				lock_in: note(
				...
				sandbox_isolation: note(
					...
					[
						source(
							"Security on the ServiceNow AI Platform",
		...
		Salesforce: {
			...
			sources: [
				source(
					...
					"https://www.salesforce.com/products/platform/best-practices/how-do-you-build-an-app/",
				),
				source(
				...
				source(
					"Salesforce mobile offline guide",
					"https://resources.docs.salesforce.com/latest/latest/en-us/sfdc/pdf/mobile_offline.pdf",
				),
				source(
					"Salesforce Files",
					"https://help.salesforce.com/s/articleView?id=sf.collab_files_overview.htm&language=en_US",
				),
			],
			cells: {
				...enterpriseWorkflowPlatformCells(
					"Salesforce",
					"Flow Builder, Lightning App Builder, Experience Cloud, mobile apps, and Agentforce",
					[
						source(
							"Lightning App Builder",
							"https://www.salesforce.com/products/platform/best-practices/how-do-you-build-an-app/",
				...
				visual_workflow: note(
					...
					[
						source(
							"Salesforce Flow",
							"https://help.salesforce.com/s/articleView?id=platform.platform_automation.htm&language=en_US&type=5",
						),
						source(
							"Lightning App Builder",
				...
				replayable: note(
					...
					[
						source(
							...
							"https://help.salesforce.com/s/articleView?id=sf.flow_considerations_design_pause.htm&language=en_US&type=5",
						),
						source(
							"Flow debugging",
							"https://help.salesforce.com/s/articleView?id=release-notes.rn_automate_flow_debug.htm&language=en_US&release=232&type=5",
						),
					],
				),
				high_volume: note(
					...
					[
						source(
							...
							"https://architect.salesforce.com/docs/architect/fundamentals/guide/async-fundamentals",
						),
						source(
							"Salesforce async decision guide",
				...
				ui_builder: note(
					...
					[
						...
						source(
							"Lightning App Builder help",
							"https://help.salesforce.com/s/articleView?id=sf.lightning_app_builder_overview.htm&language=en_US&type=5",
						),
					],
				),
				full_apps: note(
				...
				customer_facing: note(
					...
					[
						source(
							...
							"https://www.salesforce.com/products/experience-cloud/customer-community/",
						),
					],
				),
				desktop: note(
				...
				mobile: note(
					...
					[
						...
						source(
							...
							"https://help.salesforce.com/s/articleView?id=sf.salesforce_app_plus_offline.htm&language=en_US&type=5",
						),
						source(
							"Salesforce customer portal",
							"https://www.salesforce.com/products/experience-cloud/customer-community/",
				...
				offline: note(
					...
					[
						...
						source(
							"Work offline with Salesforce mobile",
							"https://help.salesforce.com/s/articleView?id=sf.salesforce_app_offline.htm&language=en_US&type=5",
						),
					],
				),
				local_first: note(
				...
				governance: note(
					...
					[
						source(
							"Salesforce Shield",
							"https://help.salesforce.com/articleView?id=salesforce_shield.htm&language=en_US",
						),
						source(
							"Agentforce 360 Platform",
							"https://www.salesforce.com/platform/agentforce-platform/",
				...
				concurrent_state: note(
					...
					[
						source(
							"Salesforce record locking",
							"https://help.salesforce.com/s/articleView?id=000387767&language=en_US&type=1",
						),
						source(
							"Paused Flow Interview considerations",
							"https://help.salesforce.com/s/articleView?id=sf.flow_considerations_design_pause.htm&language=en_US&type=5",
		...
		Regrello: {
			...
			sources: [
				source(
					...
					"https://www.salesforce.com/agentforce/agentforce-supply-chain/",
				),
				source(
					"Agentforce Supply Chain help",
					"https://help.salesforce.com/s/articleView?id=platform.automate_agentforce_supply_chain.htm&language=en_US&type=5",
				),
			...
			cells: {
				...enterpriseWorkflowPlatformCells(
					"Regrello",
					"supply-chain operations workflows, human-in-the-loop processes, AI agents, and process standardization",
					[
						source(
							"Agentforce Supply Chain",
							"https://www.salesforce.com/agentforce/agentforce-supply-chain/",
				...
				customer_facing: note(
					...
					[
						...
						source(
							"Regrello privacy policy",
							"https://www.regrello.com/privacy-policy",
						),
					],
				),
				desktop: note(
		...
		UiPath: {
			...
			sources: [
				source(
					"UiPath queue monitoring",
					"https://docs.uipath.com/orchestrator/automation-cloud-public-sector/latest/user-guide/monitoring-queues",
				),
				source(
					"UiPath Studio Web capabilities",
					"https://docs.uipath.com/studio-web/automation-suite/2.2510/user-guide/capabilities",
				),
				source(
				...
				source(
					"UiPath File Uploader",
					"https://docs.uipath.com/studio-web/automation-cloud/latest/user-guide/file-uploader",
				),
			],
			cells: {
				...rpaPlatformCells(
					"UiPath",
					"Studio, Studio Web, robots, Orchestrator queues, Apps, Maestro, and Agent Builder",
					[
						source(
							"UiPath queue monitoring",
							"https://docs.uipath.com/orchestrator/automation-cloud-public-sector/latest/user-guide/monitoring-queues",
				...
				replayable: {
					...
					sources: [
						source(
							...
							"https://docs.uipath.com/orchestrator/standalone/2021.10/user-guide/about-queues-and-transactions",
						),
						source(
							"UiPath queue management",
							"https://docs.uipath.com/orchestrator/v2020.10/docs/managing-queues-in-orchestrator",
						),
					],
					checkedAt: "2026-05-30",
				},
				...
				file_size: {
					...
					sources: [
						...
						source(
							...
							"https://docs.uipath.com/orchestrator/standalone/2022.10/user-guide/about-storage-buckets",
						),
					],
					checkedAt: "2026-05-30",
				},
				...
				ui_builder: {
					...
					sources: [
						...
						source(
							"UiPath Apps product",
							"https://www.uipath.com/product/apps",
						),
					],
					checkedAt: "2026-05-30",
				},
				...
				mobile: {
					...
					sources: [
						source(
							"UiPath mobile-friendly Apps",
							"https://docs.uipath.com/apps/automation-suite/2.2510/user-guide/build-a-mobile-friendly-app",
						),
						source(
							"UiPath Apps introduction",
							"https://docs.uipath.com/apps/automation-cloud/latest/user-guide/introduction",
				...
				offline: {
					...
					sources: [
						source(
							"UiPath Apps data flow",
							"https://docs.uipath.com/apps/automation-suite/2023.10/legacy-user-guide/data-flow-between-uipath-apps-and-orchestrator",
						),
						source(
							"UiPath Automation Suite",
							"https://docs.uipath.com/automation-suite/automation-suite/2.2510/admin-guide/about-the-automation-suite-experience",
						),
					],
					checkedAt: "2026-05-30",
				},
				...
				file_native: {
					...
					sources: [
						source(
							"UiPath File Uploader",
							"https://docs.uipath.com/apps/automation-cloud/latest/user-guide/file-uploader",
						),
						source(
							"UiPath storage buckets",
							"https://docs.uipath.com/orchestrator/standalone/2022.10/user-guide/about-storage-buckets",
				...
				governance: {
					...
					sources: [
						...
						source(
							"UiPath audit logs",
							"https://docs.uipath.com/uipath-cli/standalone/latest/user-guide/uip-orchestrator-audit-logs",
						),
					],
					checkedAt: "2026-05-30",
				},
				self_hosted: {
					...
					sources: [
						...
						source(
							"UiPath Automation Suite product",
		...
		"Automation Anywhere": {
			...
			sources: [
				...
				source(
					"Automation Anywhere APA Platform",
					"https://www.automationanywhere.com/products/agentic-process-automation-system",
				),
				source(
					"Automation Anywhere Bot Agent",
					"https://docs.automationanywhere.com/bundle/enterprise-v2019/page/enterprise-cloud/topics/bot-agent/bot-agent-overview.html",
				),
				source(
					"Automation Anywhere cloud storage usage",
					"https://docs.automationanywhere.com/bundle/enterprise-v2019/page/cp-pc-cloud-storage-usage.html",
				),
			],
			cells: {
				...rpaPlatformCells(
					"Automation Anywhere",
					"Automation 360, Control Room, Bot Agent, AI Agent Studio, document automation, and agentic process automation",
					[
						source(
							"Automation Anywhere docs",
							"https://docs.automationanywhere.com/",
				...
				visual_workflow: {
					...
					sources: [
						...
						source(
							...
							"https://docs.automationanywhere.com/bundle/enterprise-v2019/page/cp-bu-introduction.html",
						),
					],
					checkedAt: "2026-05-30",
				},
				replayable: {
					...
					sources: [
						source(
							"Automation Anywhere Control Room architecture",
						...
						source(
							...
							"https://docs.automationanywhere.com/bundle/enterprise-v2019/page/enterprise-cloud/topics/aae-client/bot-creator/using-the-workbench/cloud-manage.html",
						),
					],
					checkedAt: "2026-05-30",
				},
				...
				ui_builder: {
					...
					sources: [
						...
						source(
							"Embedded Automation Co-Pilot",
							"https://docs.automationanywhere.com/bundle/enterprise-v2019/page/enterprise-cloud/topics/aae-architecture-implementation/embedded-automations.html",
						),
					],
					checkedAt: "2026-05-30",
				},
				...
				mobile: {
					...
					sources: [
						...
						source(
							...
							"https://docs.automationanywhere.com/bundle/enterprise-v2019/page/enterprise-cloud/topics/aae-architecture-implementation/embedded-ms-teams-setup.html",
						),
					],
					checkedAt: "2026-05-30",
				},
				...
				data_science: {
					...
					sources: [
						...
						source(
							...
							"https://docs.automationanywhere.com/bundle/enterprise-v2019/page/ai-studio-faq.html",
						),
					],
					checkedAt: "2026-05-30",
				},
				...
				self_hosted: {
					...
					sources: [
						source(
							"Automation Anywhere glossary",
							"https://docs.automationanywhere.com/bundle/enterprise-v2019/page/glossary.html",
						),
						source(
							"Automation Anywhere Control Room architecture",
							"https://docs.automationanywhere.com/bundle/enterprise-v11.3/page/enterprise/topics/aae-architecture-implementation/control-room-overview.html",
		...
		"Blue Prism": {
			...
			sources: [
				...
				source(
					...
					"https://documentation.blueprism.com/bp-7-2/en-us/frmProcessStudio.htm",
				),
				source(
					"Blue Prism Control Room",
					"https://documentation.blueprism.com/bp-7-2/en-us/frmControlRoom.htm?TocPath=Interface%7CControl%7C_____0",
				),
				source(
					"Blue Prism work queues",
					"https://documentation.blueprism.com/bp-7-2/en-us/helpWorkQueues.htm",
				),
			],
			cells: {
				...rpaPlatformCells(
					"Blue Prism",
					"Process Studio, digital workers, work queues, schedules, and Control Room operations",
					[
						source("Blue Prism docs", "https://docs.blueprism.com/en-US"),
						source(
							"Blue Prism Process Studio",
				...
				high_volume: {
					...
					sources: [
						source(
							"Blue Prism ASCR",
							"https://documentation.blueprism.com/bp-7-1/en-us/ascr/ascr.htm",
						),
						source(
							"Blue Prism architecture overview",
							"https://documentation.blueprism.com/bp-7-1/en-us/Guides/infrastructure-reference/architecture-overview.htm?TocPath=Guides%7CInfrastructure+Reference+Architecture%7C_____1",
						),
					],
					checkedAt: "2026-05-30",
				},
				...
				ui_builder: {
					...
					sources: [
						source(
							"Blue Prism what's new",
							"https://documentation.blueprism.com/bp-7-4/en-us/whats-new.htm",
						),
						source(
							"Blue Prism architecture overview",
							"https://documentation.blueprism.com/bp-7-1/en-us/Guides/infrastructure-reference/architecture-overview.htm?TocPath=Guides%7CInfrastructure+Reference+Architecture%7C_____1",
		...
		"ServiceNow GRC": {
			...
			sources: [
				...
				source(
					...
					"https://www.servicenow.com/docs/r/governance-risk-compliance/continuous-risk-monitoring/work-configuration.html",
				),
				source(
					"ServiceNow AI Agents",
					"https://www.servicenow.com/products/ai-agents.html",
			...
			cells: {
				...grcPlatformCells(
					"ServiceNow GRC",
					"IRM/GRC policy, risk, compliance, audit, monitoring, and remediation workflows",
					[
						source(
							"ServiceNow GRC docs",
							"https://www.servicenow.com/docs/r/governance-risk-compliance/r_WhatIsGRC.html",
				...
				visual_workflow: note(
					...
					[
						...
						source(
							...
							"https://www.servicenow.com/docs/r/governance-risk-compliance/grc-risk-management-workspace/grc-risk-overview.html",
						),
					],
				),
				replayable: note(
				...
				file_native: note(
					...
					[
						...
						source(
							"ServiceNow mobile attachments",
							"https://horizon.servicenow.com/native-mobile/basics/leading-practices/attachments",
						),
					],
				),
				data_science: note(
					...
					[
						...
						source(
							"ServiceNow IRM agentic workflows",
							"https://www.servicenow.com/docs/r/governance-risk-compliance/grc-common-functions/using-agentic-ai-workflows.html",
						),
					],
				),
				ai_agents: note(
					...
					[
						...
						source(
							"ServiceNow AI Agents SDK guide",
		...
		Archer: {
			...
			sources: [
				...
				source(
					"Archer solutions docs",
					"https://help.archerirm.cloud/platform_202508/en-us/content/platform/solutions/solutions_intro.htm",
				),
				source(
					"Archer advanced workflow",
					"https://help.archerirm.cloud/platform_2024_11/en-us/content/platform/advancedworkflow/adv_wrkflw_basics.htm",
				),
			],
			cells: {
				...grcPlatformCells(
					"Archer",
					"integrated risk management, audit, policy, compliance, and third-party risk workflows",
					[
						source("Archer platform", "https://www.archerirm.com/"),
						source(
							"Archer solutions docs",
				...
				replayable: note(
					...
					[
						...
						source(
							"Archer building workflows",
							"https://help.archerirm.cloud/platform_202508/en-us/content/platform/advancedworkflow/adv_wrkflw_building.htm",
						),
					],
				),
				high_volume: note(
					...
					[
						source(
							"Archer data feeds",
							"https://help.archerirm.cloud/platform_2025_04/en-us/content/platform/integration/int_dfm_basics.htm",
						),
						source(
							"Archer TPRM data feeds",
							"https://help.archerirm.cloud/thirdpty_riskmgmt_69/en-us/Content/Solutions/ThirdPtyGov/tpg_tprm_df_setting_up.htm",
						),
					],
				),
				compiled: note(
					...
					[
						source(
							...
							"https://help.archerirm.cloud/platform_202508/en-us/content/platform/gettingstarted/archer.htm",
						),
						source(
							"Archer advanced workflow",
							"https://help.archerirm.cloud/platform_2024_11/en-us/content/platform/advancedworkflow/adv_wrkflw_basics.htm",
				...
				self_hosted: {
					...
					sources: [
						source("Archer platform", "https://www.archerirm.com/"),
						source(
							"Archer cloud documentation",
							"https://help.archerirm.cloud/platform_202508/en-us/content/home.htm",
						),
					],
					checkedAt: "2026-05-30",
				},
				...
				data_science: note(
					...
					[
						...
						source(
							"Archer dashboards",
							"https://help.archerirm.cloud/platform_202508/en-us/content/platform/ngx/ngx_intro_dashboards.htm",
						),
					],
				),
				ui_builder: note(
				...
				desktop: note(
					...
					[
						source(
							"Archer getting started",
							"https://help.archerirm.cloud/platform_202508/en-us/content/platform/gettingstarted/getting_started.htm",
						),
					],
				),
				mobile: note(
					...
					[
						source(
							"Archer mobile app",
							"https://help.archerirm.cloud/mobile_14/Content/Platform/UserTasks/usr_mobile_basics.htm",
						),
						source(
							"Archer dashboards",
							"https://help.archerirm.cloud/platform_202508/en-us/content/platform/ngx/ngx_intro_dashboards.htm",
		...
		OneTrust: {
			...
			sources: [
				...
				source(
					"OneTrust AI Governance announcement",
					"https://www.onetrust.com/news/onetrust-introduces-ai-governance-solution/",
				),
			],
			cells: {
				...grcPlatformCells(
					"OneTrust",
					"privacy, trust, risk, compliance, AI governance, assessments, and policy workflows",
					[
						source(
							"OneTrust platform",
							"https://www.onetrust.com/why-onetrust",
						),
						source(
							"OneTrust AI Governance",
							"https://www.onetrust.com/products/ai-governance/",
		...
		CrewAI: {
			...
			sources: [
				...
				source(
					"Deploy Crew",
					"https://docs.crewai.com/enterprise/guides/deploy-crew",
				),
			],
			cells: {
				...codeFrameworkCells(
				...
				ui_builder: {
					...
					sources: [
						...
						source(
							...
							"https://docs.langchain.com/oss/python/langgraph/agent-chat-ui",
						),
					],
					checkedAt: "2026-05-30",
				},
		...
		Dify: {
			...
			sources: [
				...
				source(
					"Dify workflow docs",
					"https://docs.dify.ai/en/use-dify/build/workflow",
				),
				source(
					"Dify self-host deployment",
				...
				source(
					"Dify publishing overview",
					"https://docs.dify.ai/en/use-dify/publish/README",
				),
				source(
					"Dify workflow web apps",
			...
			cells: {
				...openWorkflowToolCells(
					"Dify",
					"LLM apps, agents, knowledge retrieval, and visual workflows",
					[
						source(
							"Dify agent docs",
							"https://docs.dify.ai/en/use-dify/build/agent",
				...
				compiled: {
					...
					sources: [
						source(
							"Dify orchestration logic",
							"https://docs.dify.ai/en/use-dify/build/orchestrate-node",
						),
						source(
							"Dify publish to marketplace",
							"https://docs.dify.ai/en/use-dify/publish/publish-to-marketplace",
						),
					],
					checkedAt: "2026-05-30",
				},
		...
		Langdock: {
			...
			sources: [
				source(
					"Langdock feature overview",
					"https://docs.langdock.com/resources/feature-overview",
				),
				source(
					"Langdock workflows introduction",
					"https://docs.langdock.com/product/workflows/introduction",
				),
				source(
					"Langdock supported file types",
					"https://docs.langdock.com/resources/faq/supported-file-types",
				),
				source(
					"Langdock action file support",
					"https://docs.langdock.com/resources/integrations/file-support-for-actions",
				),
			],
			cells: {
				replayable: note(
					...
					[
						...
						source(
							"Langdock workflows product page",
							"https://www.langdock.com/products/workflows",
						),
					],
				),
				high_volume: note(
		...
		Flowise: {
			...
			sources: [
				...
				source(
					...
					"https://docs.flowiseai.com/configuration/deployment/docker",
				),
				source(
					"Flowise embed",
				...
				source(
					...
					"https://docs.flowiseai.com/api-reference",
				),
			],
			cells: {
				...openWorkflowToolCells(
					"Flowise",
					"chatflows, agentflows, RAG pipelines, custom code, and self-hosted LLM workflows",
					[
						source("Flowise docs", "https://docs.flowiseai.com/"),
						source(
							"Flowise agentflows",
				...
				file_native: {
					...
					sources: [
						source(
							"Flowise uploads",
							"https://docs.flowiseai.com/using-flowise/uploads",
						),
						source(
							"Flowise API reference",
							"https://docs.flowiseai.com/api-reference",
				...
				customer_facing: {
					...
					sources: [
						...
						source(
							"Flowise chatflow access control",
				...
				offline: {
					...
					sources: [
						...
						source(
							"Flowise databases",
							"https://docs.flowiseai.com/configuration/databases",
						),
					],
					checkedAt: "2026-05-30",
				},
				...
				governance: {
					...
					sources: [
						source(
							"Flowise app auth",
							"https://docs.flowiseai.com/configuration/authorization/application",
						),
						source(
							"Flowise chatflow access control",
							"https://docs.flowiseai.com/configuration/authorization/chatflow-level",
						...
						source(
							"Flowise workspaces",
							"https://docs.flowiseai.com/using-flowise/workspaces",
						),
						source(
							"Flowise environment variables",
							"https://docs.flowiseai.com/configuration/environment-variables",
		...
		"Pydantic AI": {
			...
			sources: [
				...
				source(
					...
					"https://pydantic.dev/docs/ai/durable-execution/",
				),
				source(
					"Pydantic AI native tools",
			...
			cells: {
				...
				visual_workflow: {
					...
					sources: [
						source(
							"Agno Studio Teams",
							"https://docs.agno.com/agent-os/studio/teams",
						),
				...
				full_apps: {
					...
					sources: [
						source(
							"Agno production overview",
							"https://docs.agno.com/production/overview",
						),
					],
					checkedAt: "2026-05-30",
				},
				...
				sandbox_isolation: {
					...
					sources: [
						source(
							"Agno security and auth",
							"https://docs.agno.com/runtime/security-and-auth",
						),
					],
					checkedAt: "2026-05-30",
				},
		...
		"Google ADK": {
			...
			cells: {
				...
				file_size: {
					...
					sources: [
						...
						source(
							...
							"https://adk.dev/integrations/code-exec-agent-engine/",
						),
					],
					checkedAt: "2026-05-30",
				},
				file_native: {
					...
					sources: [source("ADK artifacts", "https://adk.dev/artifacts/")],
					checkedAt: "2026-05-30",
				},
				data_science: {
					summary:
				...
				ui_builder: {
					...
					sources: [
						source(
							"ADK Web Interface",
							"https://adk.dev/runtime/web-interface/",
						),
						source("ADK Visual Builder", "https://adk.dev/visual-builder/"),
					],
					checkedAt: "2026-05-30",
				...
				full_apps: {
					...
					sources: [source("ADK deploy", "https://adk.dev/deploy/")],
					checkedAt: "2026-05-30",
				},
				customer_facing: {
					summary:
				...
				desktop: {
					...
					sources: [source("ADK home", "https://adk.dev/")],
					checkedAt: "2026-05-30",
				},
				mobile: {
					summary:
		...
		LlamaIndex: {
			...
			sources: [
				...
				source(
					"LlamaIndex checkpointing",
					"https://docs.llamaindex.ai/en/stable/examples/workflow/checkpointing_workflows/",
				),
				source(
			...
			cells: {
				...codeFrameworkCells(
					...
					[
						...
						source(
							"LlamaIndex multi-agent workflows",
				...
				ui_builder: note(
					...
					[
						source(
							"LlamaIndex full-stack app guide",
							"https://developers.llamaindex.ai/python/framework/understanding/putting_it_all_together/apps/fullstack_app_guide/",
						),
					],
				),
				full_apps: note(
				...
				local_first: note(
					...
					[
						...
						source(
							"LlamaIndex durable workflows",
							"https://docs.llamaindex.ai/en/stable/workflows/durable_workflows/",
						),
					],
				),
				self_hosted: note(
				...
				governance: {
					...
					sources: [source("LlamaIndex docs", "https://docs.llamaindex.ai/")],
					checkedAt: "2026-05-30",
				},
				concurrent_state: {
					summary:
			...
			cells: {
				...
				governance: {
					...
					sources: [
						...
						source("Haystack ecosystem", "https://haystack.deepset.ai/"),
						source(
							"Haystack Enterprise RBAC",
							"https://www.deepset.ai/blog/haystack-platform-rbac-ai-security",
						),
					],
					checkedAt: "2026-05-30",
				},
		...
		"Make.com": {
			...
			sources: [
				...
				source(
					...
					"https://help.make.com/working-with-files",
				),
				source(
					"Make app concepts",
					"https://www.make.com/en/help/app/app.html",
				),
			],
			cells: {
				...hostedAutomationCells(
					"Make.com",
					"visual app integration and AI-assisted scenarios",
					[
						source("Make help center", "https://www.make.com/en/help"),
						source("Make AI Agents", "https://www.make.com/en/ai-agents"),
						source(
				...
				replayable: {
					...
					sources: [
						...
						source(
							"Scenario run replay announcement",
							"https://help.make.com/scenario-run-replay-and-naming-capabilities-now-available",
						),
					],
					checkedAt: "2026-05-30",
				},
				...
				customer_facing: {
					...
					sources: [
						...
						source(
							"Create AI agents for triggers",
							"https://help.make.com/create-ai-agents-for-different-triggers",
						),
					],
					checkedAt: "2026-05-30",
				},
		...
		Workato: {
			...
			sources: [
				...
				source(
					"Workato platform limits",
					"https://docs.workato.com/en/limits.html",
				),
				source(
					"Workato on-prem agent",
					"https://docs.workato.com/on-prem.html",
				),
				source("Workato recipe jobs", "https://docs.workato.com/recipes/jobs"),
				source(
					"Workato Workflow apps",
					"https://docs.workato.com/en/workflow-apps.html",
				),
				source(
					"Workato RBAC",
					"https://docs.workato.com/user-accounts-and-teams/role-based-access/",
				),
			],
			cells: {
				...hostedAutomationCells(
					"Workato",
					"enterprise recipes, connectors, and workflow apps",
					[
						source("Workato docs", "https://docs.workato.com/"),
						source(
							"Workato platform limits",
				...
				replayable: {
					...
					sources: [
						...
						source(
							"RecipeOps rerun jobs",
							"https://docs.workato.com/connectors/recipeops/actions/rerun-jobs.html",
						),
					],
					checkedAt: "2026-05-30",
				},
				...
				ui_builder: {
					...
					sources: [
						...
						source(
							"Workato create page",
							"https://docs.workato.com/workflow-apps/pages-create.html",
						),
					],
					checkedAt: "2026-05-30",
				},
				full_apps: {
					...
					sources: [
						...
						source(
							"Workato Workflow apps getting started",
							"https://docs.workato.com/en/workflow-apps/getting-started.html",
						),
					],
					checkedAt: "2026-05-30",
				},
				customer_facing: {
					...
					sources: [
						source(
							"Workato Embedded Connection Widget",
							"https://docs.workato.com/oem/embedded-connections.html",
						),
						source(
							"Workato Workflow apps limits",
							"https://docs.workato.com/en/workflow-apps/limits.html",
						),
					],
					checkedAt: "2026-05-30",
				},
				governance: {
					...
					sources: [
						...
						source(
							...
							"https://docs.workato.com/features/environments.html",
						),
						source(
							"RecipeOps by Workato",
							"https://docs.workato.com/en/connectors/recipeops.html",
						),
					],
					checkedAt: "2026-05-30",
				},
		...
		Pipedream: {
			...
			sources: [
				...
				source(
					"Pipedream AI actions",
					"https://pipedream.com/docs/connect/ai/",
				),
				source(
					"Pipedream events",
					"https://pipedream.com/docs/workflows/events/",
				),
				source("Pipedream Connect", "https://pipedream.com/docs/connect"),
				source(
					"Pipedream workspaces",
					"https://pipedream.com/docs/workspaces/",
				),
			],
			cells: {
				...hostedAutomationCells(
					"Pipedream",
					"developer-oriented API workflows and managed code steps",
					[
						source("Pipedream docs", "https://pipedream.com/docs/"),
						source(
							"Pipedream workflow limits",
				...
				visual_workflow: note(
					...
					[
						...
						source(
							...
							"https://pipedream.com/docs/workflows/quickstart",
						),
					],
				...
				compiled: {
					...
					sources: [
						source(
							...
							"https://pipedream.com/docs/workflows/building-workflows/code",
						),
					],
					checkedAt: "2026-05-30",
				},
		...
		OpenClaw: {
			...
			sources: [
				...
				source(
					"OpenClaw sandbox",
					"https://openclawlab.com/en/docs/concepts/sandbox/",
				),
				source(
					"OpenClaw session concurrency",
					"https://openclawlab.com/en/docs/deep-dive/framework-focus/session-concurrency-framework/",
				),
			],
			cells: {
				...
				customer_facing: note(
					...
					[
						source(
							...
							"https://openclawlab.com/en/docs/platforms/android/",
						),
						source(
							"OpenClaw iOS app",
							"https://openclawlab.com/en/docs/platforms/ios/",
						),
						source(
							"OpenClaw macOS app",
							"https://openclawlab.com/en/docs/platforms/macos/",
						),
					],
				),
				desktop: {
					...
					sources: [
						...
						source(
							"OpenClaw gateway on macOS",
							"https://openclawlab.com/en/docs/platforms/mac/gateway/",
						),
					],
					checkedAt: "2026-05-30",
				},
				...
				self_hosted: {
					...
					sources: [
						...
						source(
							"OpenClaw Docker",
							"https://openclawlab.com/en/docs/install/docker/",
						),
					],
					checkedAt: "2026-05-30",
				},
				...
				sandbox_isolation: {
					...
					sources: [
						...
						source(
							...
							"https://openclawlab.com/en/docs/cli/sandbox/",
						),
						source(
							"OpenClaw tool policy and approvals",
							"https://openclawlab.com/en/docs/deep-dive/framework-focus/tool-policy-exec-approvals/",
						),
					],
					checkedAt: "2026-05-30",
				},
				...
				concurrent_state: {
					...
					sources: [
						...
						source(
							...
							"https://openclawlab.com/en/docs/concepts/command-queue/",
						),
					],
					checkedAt: "2026-05-30",
				},
		...
		"Hermes Agent": {
			...
			cells: {
				...
				local_first: {
					...
					caveat: "Model calls may still depend on external model providers.",
					sources: [
						source(
							"Hermes Agent CLI docs",
							"https://hermes-agent.nousresearch.com/docs/user-guide/cli/",
				...
				offline: note(
					...
					[
						source(
							...
							"https://docs.openhands.dev/usage/installation",
						),
						source(
							"OpenHands sandbox overview",
							"https://docs.openhands.dev/usage/runtimes/overview",
		...
		Goose: {
			...
			sources: [
				...
				source(
					"Goose extensions",
					"https://block.github.io/goose/docs/guides/using-extensions/",
				),
			...
			cells: {
				...
				visual_workflow: note(
					...
					[
						...
						source(
							"Goose recipes",
							"https://block.github.io/goose/docs/tutorials/recipes-tutorial",
						),
						source(
							"Goose extensions",
				...
				ui_builder: note(
					...
					[
						source(
							"Goose MCP-UI extensions",
							"https://block.github.io/goose/docs/guides/interactive-chat/mcp-ui/",
						),
						source("Goose docs", "https://block.github.io/goose/"),
					],
				),
		...
		"Gemini CLI": {
			...
			sources: [
				...
				source(
					...
					"https://google-gemini.github.io/gemini-cli/docs/checkpointing/",
				),
				source(
					"Gemini CLI sandboxing",
					"https://google-gemini.github.io/gemini-cli/docs/sandboxing/",
				),
				source(
					"Gemini CLI enterprise",
					"https://google-gemini.github.io/gemini-cli/docs/enterprise/",
				),
				source(
					"Gemini CLI GitHub",
			...
			cells: {
				...
				offline: note(
					...
					[
						...
						source(
							"Gemini CLI core",
							"https://google-gemini.github.io/gemini-cli/docs/core/",
						),
					],
				),
				self_hosted: {
				...
				governance: {
					...
					sources: [
						...
						source(
							...
							"https://google-gemini.github.io/gemini-cli/docs/telemetry/",
						),
					],
					checkedAt: "2026-05-30",
				},
		...
		Agencies: {
			...
			cells: {
				...customBuildCells(
					"Agencies",
					"external delivery contracts and agency-operated implementation",
					[
						source(
							"NIST secure software development",
							"https://csrc.nist.gov/pubs/sp/800/218/final",
		...
		Contractors: {
			...
			cells: {
				...customBuildCells(
					"Contractors",
					"contracted implementation by a small external team or individual",
					[
						source(
							"NIST secure software development",
							"https://csrc.nist.gov/pubs/sp/800/218/final",
	...
	const supportMeaning: Record<string, string> = {
		native:
			"Native means the product publicly documents this as a first-class capability.",
		partial:
			"Partial means the product has adjacent support, but with scope, deployment, or product-fit limits.",
		...
		basic:
			"Basic means the product has some governance or control surface but not a broad enterprise control plane.",
		enterprise:
			"Enterprise means the capability is primarily documented as an enterprise-grade or admin/governance feature.",
		js: "JS means the product mainly exposes this through JavaScript or Node.js code paths.",
		unlimited:
			"Unlimited means no practical product-level cap was identified in the reviewed public sources.",
		depends:
			"Depends means the answer is implementation-specific rather than a fixed product capability.",
	};

	const supportRationale: Record<string, string> = {
		native:
			"the reviewed sources show this as a first-party product capability.",
		partial:
			"the reviewed sources show adjacent support, but with scope, deployment, or product-fit limits.",
		...
		basic:
			"the reviewed sources show some controls, but not a broad enterprise control plane.",
		enterprise:
			"the reviewed sources position this as an enterprise-grade admin, security, or governance capability.",
		js: "the product mainly exposes this through JavaScript or Node.js code paths.",
		unlimited:
			"no practical product-level cap was identified in the reviewed public sources.",
		depends:
			"the real answer depends on deployment, configuration, integration path, or implementation choices.",
	};

	const capabilityMeaning: Record<string, string> = {
		visual_workflow:
			"This cell looks for a visual workflow/canvas builder rather than only code-defined pipelines.",
		replayable:
			"This cell looks for durable replay, run history, retries, or reconstruction of workflow execution.",
		high_volume:
			"This cell looks for scale characteristics suitable for large workloads, queues, datasets, or enterprise automation.",
		compiled:
			"This cell looks for compiled or native business logic rather than interpreted scripts or hosted configuration.",
		file_size:
			"This cell looks at file/payload handling limits and whether large documents or datasets are a normal use case.",
		file_native:
			"This cell looks for file-native workflows where files are first-class local or project artifacts.",
		data_science:
			"This cell looks for data, analytics, ML, RAG, or pipeline use cases beyond simple task automation.",
		ai_agents:
			"This cell looks for first-class AI agents, tools, memory, or agent orchestration.",
		ui_builder:
			"This cell looks for custom UI construction such as forms, dashboards, and app screens.",
		full_apps:
			"This cell looks for shipping complete apps, not only dashboards, bots, workflows, or connectors.",
		customer_facing:
			"This cell looks for safe delivery to external users or customers rather than only internal operators.",
		desktop:
			"This cell looks for desktop app/runtime support, not just browser access.",
		mobile: "This cell looks for mobile app/runtime support.",
		offline:
			"This cell looks for offline execution or offline-capable user experiences.",
		local_first:
			"This cell looks for an architecture where data and projects can primarily live locally or under the customer's direct control.",
		governance:
			"This cell looks for admin, audit, security, policy, access-control, and compliance controls.",
		self_hosted:
			"This cell looks for self-hosting, on-prem, VPC, hybrid, or customer-controlled deployment.",
		lock_in:
			"This cell looks at practical migration risk around data, workflow definitions, runtime, and vendor platform coupling.",
		sandbox_isolation:
			"This cell looks for isolation around tool/code execution and untrusted automation.",
		concurrent_state:
			"This cell looks for transactional or otherwise safe handling of concurrent workflow/application state.",
	};
	...
	const getSupportNote = (
		...
		const supportExplanation =
			typeof support === "string" && support.startsWith("limited-")
				? "public materials or matrix research identify a concrete file/payload cap for this product."
				: (supportRationale[support] ??
					"the current matrix research supports this rating.");

		return {
			summary: `${comp.name} gets a ${supportText} rating for ${t(`compare.cap.${cap}`)} because ${supportExplanation}`,
			evidence:
				`${research?.summary ?? "This row is based on public product documentation and the current comparison model."} ${capabilityMeaning[cap] ?? ""}`.trim(),
			caveat:
					...
					notes: {
						file_size: {
							...
							sources: [
								...
								source(
									"Zapier Forms file uploads",
									"https://help.zapier.com/hc/en-us/articles/32816445802893-Use-the-file-upload-field-type-in-Zapier-Interfaces-forms",
								),
							],
							checkedAt: "2026-05-30",
						},
						...
						ui_builder: {
							...
							sources: [
								source(
									"Zapier Interfaces",
									"https://help.zapier.com/hc/en-us/articles/14490267815949-Create-interactive-pages-and-apps-with-Zapier-Interfaces-Beta-",
								),
								source(
									"Zapier Tables",
									"https://help.zapier.com/hc/en-us/articles/8496297232781-Create-and-use-Zapier-Tables",
								),
							],
							checkedAt: "2026-05-30",
						},
				...
				},
				{
					...
					notes: {
						...
						local_first: {
							...
							caveat: "This is an architectural inference from public docs.",
							sources: [
								{
									label: "Langdock feature overview",
									url: "https://docs.langdock.com/resources/feature-overview",
	...
	const renderSupport = (
		...
		if (support === "high")
			return { icon: "⚠", color: "red", label: t("compare.support.high") };
		if (support === "low")
			return { icon: "○", color: "emerald", label: t("compare.support.low") };
		if (support === "saas") return { icon: "◐", color: "amber", label: "SaaS" };
		if (support === "basic")
			return { icon: "◐", color: "amber", label: t("compare.support.basic") };
		if (support === "enterprise")
			return { icon: "◐", color: "amber", label: "Enterprise" };
		if (support === "js") return { icon: "◐", color: "amber", label: "JS" };
		if (support === "unlimited")
			return {
				icon: "∞",
				color: "emerald",
				label: t("compare.support.unlimited"),
			};
		if (support === "depends")
			return { icon: "?", color: "muted", label: t("compare.support.depends") };
		if (typeof support === "string" && support.startsWith("limited-")) {
	...
	const supportScore = (support: Support): number => {
		if (support === "native" || support === "unlimited" || support === "low")
			return 1;
		if (support === "partial" || support === "js" || support === "enterprise")
			return 0.55;
		if (support === "saas" || support === "basic" || support === "depends")
			return 0.4;
	...
	const axisScore = (caps: Record<string, Support>, axis: AxisSpec): number => {
		...
		const sum = axis.caps.reduce(
			(acc, k) => acc + supportScore(caps[k] ?? "none"),
			0,
		);
	...
	const competitorPosition = (
		...
		const jitterY =
			count > 1
				? (((index * 7) % Math.max(count, 3)) - (count - 1) / 2) *
					(spread * 0.6)
				: 0;
		return {
