...
function CourseDetailContent() {
	...
	return (
		<div className="flex-1 overflow-auto">
			<div className="relative h-48 overflow-hidden border-b bg-linear-to-br from-primary/15 via-card/80 to-purple-500/10">
				{course?.banner_url ? (
					<div
					...
					<BookOpen
						className="absolute right-10 top-1/2 -translate-y-1/2 h-32 w-32 text-foreground/10"
						strokeWidth={1.25}
					/>
				)}
			</div>
