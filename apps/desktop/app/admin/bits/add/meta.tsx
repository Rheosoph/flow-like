				...
				<CardContent className="space-y-4">
					<div className="grid grid-cols-1 md:grid-cols-3 gap-4">
						...
						<div className="space-y-2">
							<Label htmlFor="age-rating">
								{t("ageRatingValue", "Age Rating [{{rating}}+]", {
									rating: getMeta("age_rating") ?? 0,
								})}
							</Label>
							<Slider
								id="age-rating"
					...
					<div className="space-y-2">
						...
						<Textarea
							...
							placeholder={t('briefDescriptionOfTheModel2', 'Brief description of the model')}
							rows={2}
							required
						/>
					</div>
					...
					<div className="space-y-2">
						...
						<Textarea
							...
							placeholder={t('detailedDescriptionOfTheModelsCapabilitiesAndUseCases2', 'Detailed description of the model\'s capabilities and use cases')}
							rows={4}
						/>
					</div>
				</CardContent>
