...
export default function AddProfilePage() {
	...
	const handleSave = useCallback(async () => {
		...
		try {
			...
			toast.success(
				isEditing
					? t("profileTemplateUpdated", "Profile template updated")
					: t("profileTemplateCreated", "Profile template created"),
			);
			if (isEditing) {
		...
		<div className="container mx-auto p-6 max-w-4xl">
			<div className="mb-6">
				<h1 className="text-3xl font-bold">
					{isEditing
						? t("editProfileTemplate", "Edit Profile Template")
						: t("createNewProfileTemplate", "Create New Profile Template")}
				</h1>
				<p className="text-muted-foreground">
					{t(
						"configureReusableProfileTemplatesIncludingDefaultBitsHubsAndMetadata",
			...
			<div className="grid gap-6">
				...
				<Card>
					<CardHeader>
						...
						<CardDescription>
							{t(
								"setUpTheFundamentalProfileDetailsAndAppearance",
					...
					<CardContent className="space-y-4">
						...
						<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
							...
							<div className="space-y-3">
								<Label>
									{t("profileThumbnail169", "Profile Thumbnail (16:9)")}
								</Label>
								<div className="space-y-3">
						...
						<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
							...
							<div className="space-y-2">
								...
								<Input
									...
									placeholder={t(
										"enterHubUrlOrIdentifier",
										"Enter hub URL or identifier",
									)}
								/>
							</div>
						</div>
				...
				<Card>
					<CardHeader>
						...
						<CardDescription>
							{t(
								"manageAdditionalHubsAssociatedWithThisProfile",
				...
				<Card>
					<CardHeader>
						...
						<CardDescription>
							{t(
								"selectAndManageBitIdsAssociatedWithThisProfile",
				...
				<Card>
					<CardHeader>
						<CardTitle>
							{t("connectionSettings", "Connection Settings")}
						</CardTitle>
						<CardDescription>
							{t(
								"configureHowConnectionsAreDisplayedAndManaged",
				...
				<Card>
					<CardHeader>
						...
						<CardDescription>
							{t(
								"addTagsToCategorizeAndOrganizeThisProfile",
				...
				<Card>
					<CardHeader>
						...
						<CardDescription>
							{t(
								"defineInterestsAndTopicsRelevantToThisProfile",
			...
			<div className="flex justify-end gap-2">
				...
				<Button onClick={handleSave} className="flex items-center gap-2">
					...
					{isEditing
						? t("updateTemplate", "Update Template")
